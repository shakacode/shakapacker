...
If you are using a CDN setup, Shakapacker does NOT use the `ASSET_HOST` environment variable to prefix URLs for assets. You must use the `WEBPACKER_ASSET_HOST` environment variable instead.
