...
if (moduleExists("css-loader")) {
  console.log("[Shakapacker] css-loader found, loading CSS rule configuration...")
  const css = require("./css")
  if (css) {
    console.log("[Shakapacker] Successfully added CSS rule")
    rules.push(css)
  } else {
    console.log("[Shakapacker] WARNING: css-loader found but rule configuration returned null")
  }
} else {
  console.log("[Shakapacker] INFO: Skipping CSS support - css-loader not installed")
}

// Sass rules
console.log("[Shakapacker] Checking for Sass loader...")
if (moduleExists("sass") && moduleExists("sass-loader")) {
  console.log("[Shakapacker] sass and sass-loader found, loading Sass rule configuration...")
  const sass = require("./sass")
  if (sass) {
    console.log("[Shakapacker] Successfully added Sass rule")
    rules.push(sass)
  } else {
    console.log("[Shakapacker] WARNING: sass and sass-loader found but rule configuration returned null")
  }
  ...
  console.log("[Shakapacker] INFO: Skipping Sass support - sass-loader not installed")
}

// Less rules
console.log("[Shakapacker] Checking for Less loader...")
if (moduleExists("less") && moduleExists("less-loader")) {
  console.log("[Shakapacker] less and less-loader found, loading Less rule configuration...")
  const less = require("./less")
  if (less) {
    console.log("[Shakapacker] Successfully added Less rule")
    rules.push(less)
  } else {
    console.log("[Shakapacker] WARNING: less and less-loader found but rule configuration returned null")
  }
  ...
  console.log("[Shakapacker] INFO: Skipping Less support - less-loader not installed")
}

// Stylus rules
console.log("[Shakapacker] Checking for Stylus loader...")
if (moduleExists("stylus") && moduleExists("stylus-loader")) {
  console.log("[Shakapacker] stylus and stylus-loader found, loading Stylus rule configuration...")
  const stylus = require("./stylus")
  if (stylus) {
    console.log("[Shakapacker] Successfully added Stylus rule")
    rules.push(stylus)
  } else {
    console.log("[Shakapacker] WARNING: stylus and stylus-loader found but rule configuration returned null")
  }
} else if (!moduleExists("stylus")) {
  console.log("[Shakapacker] INFO: Skipping Stylus support - stylus not installed")
} else if (!moduleExists("stylus-loader")) {
  console.log("[Shakapacker] INFO: Skipping Stylus support - stylus-loader not installed")
}
...
if (erb) {
  ...
  console.log("[Shakapacker] INFO: Skipping ERB support - rails-erb-loader not installed")
}
...
console.log(`[Shakapacker] Rspack rules configuration complete. Total rules: ${rules.length}`)
