...
exports.isValidDevServerConfig = isValidDevServerConfig;
exports.isValidYamlConfig = isValidYamlConfig;
exports.isPartialConfig = isPartialConfig;
 ...
 */
function isValidDevServerConfig(obj) {
    if (typeof obj !== 'object' || obj === null) {
        return false;
    }
    const config = obj;
 ...
 */
function isValidYamlConfig(obj) {
    if (typeof obj !== 'object' || obj === null) {
        return false;
    }
    const config = obj;
 ...
 */
function createConfigValidationError(configPath, environment, details) {
