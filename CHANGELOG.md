...
- **Added `webpack_compile_flags` configuration**. Allows Rails-driven Shakapacker compiles to pass extra webpack/rspack CLI flags, such as `--fail-on-warnings` or `--progress`, through `bin/shakapacker`. Fixes [#1175](https://github.com/shakacode/shakapacker/issues/1175).
