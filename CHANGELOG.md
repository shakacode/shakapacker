...
- **RBS type signatures for all public APIs**. [PR #822](https://github.com/shakacode/shakapacker/pull/822) by [justin808](https://github.com/justin808). Shakapacker now includes comprehensive RBS type signatures in the `sig/` directory, providing static type checking and improved IDE support. Benefits include IDE autocomplete, static type checking with Steep/TypeProf, self-documenting code, and safer refactoring. Type signatures cover all core APIs including `Shakapacker`, `Configuration`, `Helper`, `Manifest`, `Compiler`, `Commands`, and `DevServer`. See the README section on "Type Signatures with RBS" for usage examples and benefits.
