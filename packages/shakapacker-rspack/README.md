...
Rspack includes SWC transpilation, so no separate JavaScript transpiler package is required. Install optional peers such as `@rspack/plugin-react-refresh@2.0.0`, `css-loader@7.1.4`, `sass@1.99.0`, and `sass-loader@16.0.7` only when your app uses those features.
